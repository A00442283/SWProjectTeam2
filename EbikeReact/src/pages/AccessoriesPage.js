...
export default function AccessoriesPage() {
    ...
    function saveCustomizationAndRedirect(page,card) {
        var x = { ...savedConfig };
        x['accessoriesId'] = card.accessoriesId;
        x['accessoriesPrice'] = card.price;
        x['accessoriesType'] = card.type;
        setSavedConfig(x);
        debugger
        let y = { ...feature };
        ...
        <React.Fragment>
            ...
            <AppBar position="relative">
                <Toolbar className="wizard">
                    <SportsMotorsportsIcon className={classes.icon} />
                ...
                <div className={classes.heroContent}>
                    <Container maxWidth="md">
                        <Typography component="h1" variant="h2" align="center" color="textPrimary" gutterBottom className={classes.bikehead}>
                            Make the mose out of your bike
                        </Typography>
                            ...
                            <Grid item key={card} xs={12} sm={6} md={4}>
                                <Card className={classes.card}>
                                    <CardMedia
                                        ...
                                        image={card.accessoriesId % 3 === 1 ? acc1 : card.accessoriesId % 3 === 2 ? acc2 : acc3}
                                        title="Image title"
                                    />
                                    ...
                                    <CardActions>
                                        ...
                                        <Button onClick={()=>{saveCustomizationAndRedirect('BikesPage',card)}}
